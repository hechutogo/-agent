    ...
    try:
        with ExitStack() as stack:
            if not args.smoke and args.demo is None:
                ...
                locate = CloudPerception(vision_client, vision.model).locate
            ...
            if args.demo is not None:
                from .perception import ColorPerception
            ...
            print("Perception: cloud bbox + local RGB-color refinement of measured depth.")
            turn = 0
            while True:
                if command is None:
                    try:
        ...
        from .cloud import CloudError, ConfigurationError
